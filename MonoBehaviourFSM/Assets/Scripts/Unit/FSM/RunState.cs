...
public class RunState : UnitStateBase
{
    public override UNITSTATE StateType => UNITSTATE.RUN;
    ...
    public override void Enter(UnitMain unitMain)
    {
        ...
        uMain.uAnimator.SetAnimatorBool("IsRunning", true);
    }
    ...
    public override void OnRun(bool isRunning)
    {
        if (!isRunning)
        {
            uMain.uState.SwitchState(UNITSTATE.WALK);
        }
    }
